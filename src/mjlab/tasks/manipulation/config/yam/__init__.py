...
register_mjlab_task(
  task_id="Mjlab-Lift-Cube-Yam-Rgb-Naive",
  env_cfg=yam_lift_cube_rgb_naive_env_cfg(),
  play_env_cfg=yam_lift_cube_rgb_naive_env_cfg(play=True),
  rl_cfg=yam_lift_cube_rgb_naive_ppo_runner_cfg(),
  runner_cls=ManipulationOnPolicyRunner,
)

register_mjlab_task(
  task_id="Mjlab-Lift-Cube-Yam-Rgb-Dr",
  env_cfg=yam_lift_cube_rgb_dr_env_cfg(),
  play_env_cfg=yam_lift_cube_rgb_dr_env_cfg(play=True),
  rl_cfg=yam_lift_cube_rgb_dr_ppo_runner_cfg(),
  runner_cls=ManipulationOnPolicyRunner,
)
